...
class PageController extends Controller
{
    ...
    public function getLoaisp($type){
        ...
        return view('page.loaisanpham',compact('sp_theoloai','sp_khac','loai','loap_sp'));
    }
    ...
    public function postLogin(Request $req){
        ...
        if(Auth::attempt($credentials)){
            return redirect()->route('trang-chu')->with(['flag'=>'success','massage'=>'Đăng nhập thành công']);
        }
        else{
             return redirect()->back()->with(['flag'=>'danger','massage'=>'Đăng nhập không thành công']);
        }
    }
