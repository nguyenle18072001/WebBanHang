			...
			<div class="main-content">
				...
				<div class="row">
					<div class="col-sm-3">
						<ul class="aside-menu">
							@foreach($loai as $l)
								<li><a href="{{route('loaisanpham',$l->id)}}">{{$l -> name}}</li>
							@endforeach
						</ul>
					</div>
					<div class="col-sm-9">
						...
						<div class="beta-products-list">
							...
							<div class="row">
								...
								<div class="col-sm-4">
									...
									@endif
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$sp->id)}}"><img src="source/image/product/{{$sp_k->image}}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body">
											...
											@else
												<span>{{number_format($sp_k->unit_price)}} đ</span>
											@endif
											</p>
										</div>
										<div class="single-item-caption">
