<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 436/59/17 CMT8 - phường 11 - quận 3 - Thành phố Hồ Chí Minh</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 0976439641</a></li>
					</ul>
				</div>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="{{route('trang-chu')}}" id="logo"><img src="source/assets/dest/images/logo-ps5.png" width="200px" alt=""></a>
				</div>
